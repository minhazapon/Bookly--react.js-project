        ...
        <div class="mt-6 max-w-6xl max-lg:max-w-3xl mx-auto bg-black  border-[1px] border-[#00CCDD]  rounded-lg">
            <div class="grid lg:grid-cols-2 items-center gap-14 sm:p-8 p-4 font-[sans-serif]">
                ...
                <div class="bg-gray-100 p-6 rounded-lg">
                    <p class="text-sm font-semibold text-gray-800">I'm interested in Books</p>

                    <div class="space-y-4 max-lg:mt-4">

                        <Link to='/shop' >
                        <button type="button" class=" mt-5  hover:bg-purple-600 px-4 py-2 rounded-lg   text-gray-800 text-sm tracking-wider font-medium outline-none border-2 border-gray-300  mr-4 btn font-serif ">Shop</button>
                        </Link>
                        ...
                        <div className=' flex justify-center'>
                            <input className=' btn w-full  bg-[#49f0ff] ' type="submit" value="Send" />
                        </div>    
